...
export class GameState {
    ...
    mistakes = 0;
    hintsUsed = 0;
    constructor(initialGrid, solutionGrid) {
     ...
     */
    makeMove(row, col, value, moveType = 'value') {
     ...
     */
    setCellHighlight(row, col, highlighted) {
        if (this.isValidPosition(row, col)) {
            const cellState = this.getCellState(row, col);
     ...
     * Set cell selection
     */
    setCellSelection(row, col, selected) {
        if (this.isValidPosition(row, col)) {
            const cellState = this.getCellState(row, col);
     ...
     */
    isValidSudokuMove(row, col, value) {
        // Check row
